...
!function e(t, i, n) {
        ...
        var n = e("./Event")
            ...
            checkVersion: function(e) {
                var t = r.getCookie(o.version)
                        , i = !1;
                return r.s(t) && t.length > 0 && (t = parseInt(t, 10),
                t > e && (i = !0)),
                        i
            }
        }
            ...
            isChrome: function() {
                var e = this.ua;
                return e.match(/360 aphone /i) ? !1 : "chrome" == e.match(/Chrome/i)
            },
            query: function(e) {
                var t = "";
                for (var i in e)
            ...
            open: function(e, t) {
                var i = this
                        ...
                        , m = o.getBaseUrl();
                n.support(n.act.d) ? (d = m + c.jump + encodeURIComponent(e) + (t ? "&appname=" + r.getCurrentBs() : ""),
                        i.iframe(d)) : i.run(d, !0)
            },
            batchDownload: function(e, callback) {
                //ww:2.1
                this.download(e, callback, l.act.b)
            },
            download: function(e, callback, t) {
                // alert("download(e)");
                // alert(e);
                ...
                var i = this
                        ...
                        , r = i.reqUrl
                        , c = i.reqMethod
                        , d = r.appdetail + encodeURIComponent(e)
                        , m = o.getBaseUrl();
                // alert(d);
                if (n.support(t)){
                    switch (t) {
                        case n.act.dl:
                            d = m + c.download + encodeURIComponent(r.downloadUri.replace("{contentid}", e));
                            // alert("d1");
                            // alert(d);
                            i.iframe(d);
                            break;
                        case n.act.b:
                            d = m + c.batchdownload + e;
                            // alert("d2");
                            // alert(d);
                    ...
                    i.run(d, !0);
                    var u = function() {
                        if (n.support(n.act.d)) {
                            var e = m + c.jump + encodeURIComponent(r.appdetail + r.MM_CONTENT_ID) + (s.showtitle ? "&appname=" + p.getCurrentBs() : "");
                            i.iframe(e)
                        } else {
                            var e = r.appdetail + encodeURIComponent(r.MM_CONTENT_ID);
                            i.run(e, !0)
                        }
                    };
                    a.one("dialog.after.show", function() {
            ...
            detail: function(e, t) {
                ...
                var i = this
                        ...
                        , m = o.getBaseUrl();
                n.support(n.act.d) ? (d = m + c.jump + encodeURIComponent(a.appdetail + e) + (t ? "&appname=" + r.getCurrentBs() : ""),
                        i.iframe(d)) : i.run(d, !0)
            },
            error: function() {
                ...
                if (o.isWechat()) {
                    ...
                    if (v) {
                        ...
                        if (s.useGuide) {
                            ...
                            var g = "detail" === m[0] || "open" === m[0] ? "detail" : "download";
                            a.show({
                                type: "weixin",
                                flag: g
                            })
                            ...
                            h();
                        n.trigger("server.over.error", u)
                    }
                }
                else if (!t && v){
                    //alert("error11()");
                    e.downloadmm.apply(e, m);
                }
                else {
                    // alert("error12()");
                    ...
                    if ("open" === u) {
                        ...
                        var M = m[1];
                        M && !l ? e.iframe(i.appdetail + M) : e.iframe(i.index)
                    } else if("download" === u){
                        var url = i.download2 + encodeURIComponent(this.reqUrl.downloadUri.replace("{contentid}", m[1]));
                        // alert(url);
                        e.iframe(url);
                    }
                    else if("batchDownload" === u){
                        var url = i.batchDownload2 + m[1];
                         console.log('url='+url);
                        e.iframe(url);
                    }
                    else{
                    ...
                    /*原来*/
                    var b = function(){
                        m.unshift("downloadmm"), m.unshift("server.check.start"), n.trigger.apply(n, m)
                    };
                    setTimeout(function(){
                        var t = Date.now();
                        // l ? b() : !A || d+200>t-A ? f ? b() : !u && e.downloadmm.apply(e, m) : f && b()
                        if(l){
                            b()
                        }else{
                            if(!A || d+200>t-A){
                                f ? b() : !u && e.downloadmm.apply(e, m)
                            }else{
                                f && b()
                            }
                        }
            ...
            /*error: function(){
                var e = this, t = s.onIntent, i = e.reqUrl, o = p, r = o.ua.match(/(UCBrowser)|(UCWEB)/i),
                        l = r || o.isQq() ? 1 : 0, d = r ? 5e3 : 3900, m = c.call(arguments), u = s.errorSilent,
                        v = m[0];
                if(o.isWechat()){
                    if(!u){
                        var h = function(){
                        ...
                        if(s.useGuide){
                            ...
                            var g = "detail"===m[0] || "open"===m[0] ? "detail" : "download";
                            a.show({type: "weixin", flag: g}), n.trigger("server.over.error", v)
                        }else h()
                    }
                }
                else if(t){
                    var A = Date.now(), f = "open"!=v && "detail"!=v;
                    if("open"===v){
                        var w = m[1];
                        w && !l ? e.iframe(i.launch+encodeURIComponent(w)) : e.iframe(i.index)
                    }else if("detail"===v){
            ...
            downloadmm: function(e) {
                ...
                if (n.trigger("server.over.error", e),
                        s.downloadmm && e) {
                    var v = function() {
                        var t = "";
                        switch (e) {
                        ...
                        return t
                            ...
                            , h = t.getMMUrl(v);
                    if ("" == m || !u && v == i.act.b || v == i.act.d ? t.downloadApp(h.replace("{contentid}", "")) : t.downloadApp(h.replace("{contentid}", d)),
                                    s.useGuide) {
                        var g = v == i.act.d || "open" == v ? "detail" : "download"
                                , A = c.call(arguments);
                        A.unshift("server.check.start");
                        var f = function() {
                            n.trigger.apply(n, A)
                        };
                        setTimeout(function() {
        ...
        var n = e("./Event")
            ...
            set: function(e) {
                ...
                for (var i in t.options)
                    "undefined" != typeof e[i] && (t.options[i] = e[i])
            },
            view: function() {
                var e = this
                        , t = ""
            ...
            refresh: function() {
                ...
                if (null != t) {
                    ...
                    "guid" != e.options.type && (t.style.height = Math.max(document.body.scrollHeight, document.body.clientHeight) - 1 + "px",
                            t.setAttribute("class", "__mm-wap-toast-cover"));
                    var n = (document.body.offsetHeight || document.documentElement.offsetHeight,
                            e.query("__mm-wap-dialog"))
                            , o = e.query("toast-guide")
                            , r = n ? (window.innerHeight - n.offsetHeight) / 2 : 0;
                    n && (n.style.top = parseInt(i + r, 10) + "px",
                            1),
            ...
            addHandle: function() {
                var e = this
                        , t = e.query("__mm-wap-toast")
                        , i = [t];
                ("ios-weixin" === e.options.type || "ios" === e.options.type) && e.addEvent(t, "click", function(t) {
                ...
                null != n && n.length > 0 && (n.push("click"),
                        n.push(function(t) {
                ...
                null != o && o.length > 0 && (o.push("click"),
                        o.push(function(t) {
                            return e.preventDefault(t),
                                    e.stopPropagation(t),
            ...
            destroy: function() {
                ...
                if (e.removeEvent(window, "resize", e.resize),
                                e.removeEvent(window, "scroll", e.resize),
                        "undefined" != typeof e.el["__mm-wap-toast"]) {
    ...
    5: [function(e, t, i) {
        ...
        function s(e, t) {
            return this instanceof s ? (t && $.extend(this, t),
                    this.type = e,
                    console.log("Event init - props="),
                    console.log(t),
                    this) : new s(e,t)
        }
        var c = [].slice
        ...
        s.prototype = {
            ...
            stopPropagation: function() {
                ...
                t.exports = {
                    on: function(e, t, i) {
                        var o, a = this;
                        return t ? (o = this._events || (this._events = []),
                                n(e, t, function(e, t) {
                                    var n = r(e);
                                    n.cb = t,
                                            n.ctx = i,
                    ...
                    off: function(e, t, i) {
                        var o = this._events;
                        return o ? e || t || i ? (n(e, t, function(e, t) {
                    ...
                    trigger: function(e) {
                        ...
                        if (!this._events || !e)
                            return this;
                        if ("string" == typeof e && (e = new s(e)),
                                        t = c.call(arguments, 1),
                                        e.args = t,
                                        t.unshift(e),
                                        i = a(this._events, e.type))
                            for (o = i.length; ++l < o; )
                                if ((n = e.isPropagationStopped()) || !1 === (r = i[l]).cb.apply(r.ctx2, t)) {
                                    n || (e.stopPropagation(),
                                            e.preventDefault());
                                    break
                                }
    ...
    6: [function(e, t, i) {
        var n = e("./Util")
                ...
                , s = "127.0.0.1";
        navigator.userAgent.toLowerCase().match(/MicroMessenger|MQQBrowser/i) ? (o = o.replace("{adress}", a),
                r = r.replace("{adress}", a)) : (o = o.replace("{adress}", s),
                r = r.replace("{adress}", s)),
                t.exports = {
                    versionUrl: o,
                    baseUrl: r,
                    DAEMON: "mmcd",
    ...
    7: [function(e, t, i) {
        function n(e) {
            ...
            a(),
                    N = y.call(e.args, 1),
            g || (d.trigger("server.before.check"),
                    o(r))
        }
        function o(e) {
        ...
        function r(e) {
            if ("" === A)
                if ("load" == e.type) {
                    var t = e.target;
                    A = t.getAttribute("port"),
                            d.trigger("server.after.check", "success", A)
                } else
                    M++,
                    M == f.length && d.trigger("server.after.check", "error")
        }
        function a() {
        ...
        function c(e) {
            ...
            if (p(),
                            ...
                            A = "",
                            M = 0,
                    "success" === t[0] && (u.setCookie(m.port, t[1]),
                    "undefined" != typeof window.a && "undefined" != typeof window.a.appname)) {
                var n = l(window.a);
                if (null === G ? delete window.a : window.a = G,
                                n)
                    return N.unshift("server.check.success"),
        ...
        function l(e) {
            ...
            if (t && t.length > 0) {
                ...
                if (n) {
                    var o = n[1] || "MM";
                    if (u.setCookie(m.version_type, o.toUpperCase()),
                                    n = n[0].replace(I, ""),
                            n.length > 0) {
                        var r = n.replace(/\./g, "")
                                , a = v.versionCode();
                        (!a || a && parseInt(r, 10) >= parseInt(a, 10)) && (u.setCookie(m.version, r || 0),
                                i = 1)
                    }
                }
            }
        ...
        function p() {
            ...
            if (e.length) {
                ...
                t.forEach(function(e) {
                    ...
                    e.remove && (e.remove(),
                            1) || e.parentNode && (e.parentNode.removeChild(e),
                            1)
                })
            }
        }
        ...
        var n = {
            ...
            encode: function(e) {
                var t = this
                        , i = "";
                if (!isNaN(e))
                    for (var n = parseInt(e, 10), o = t.CHATSET, r = o.length; n > 0; n = parseInt(n / r, 10))
                        i += o.charAt(parseInt(n % r, 10));
                return i
            },
            decode: function(e) {
                if ("undefined" == typeof e || 0 == e.length)
                    return 0;
                for (var t = this.CHATSET, i = t.length, n = 0, o = 0; o < e.length; o++) {
                    var r = e.charAt(o)
                            , a = t.indexOf(r);
                    n += a * Math.pow(i, o)
                }
    ...
    9: [function(e, t, i) {
        ...
        function o(e) {
            e.mm = {
                download: function(e, callback) {
                    console.log("e=");
                    console.log(e);
                    r.trigger("server.check.start", "download", e, callback)
                },
                batchDownload: function(e, callback) {
                    // alert("batchDownload()");
                    // alert(e);
                    ...
                    if ("undefined" != typeof e && "" != e) {
                        ...
                        if (i.length > 0) {
                            ...
                            i.forEach(function(e) {
                                e && /^(\d)*$/.test(e) && ("" === n ? n = a.encode(e) : n += "-" + a.encode(e),
                                        o++)
                            }),
                                    o > t.get("batchMaxApps") ? l.show({
                                        type: "alert",
                                        info: t.get("maxAlert")
                                    }) : "" != n && r.trigger("server.check.start", "batchDownload", n, callback)
                        }
                    }
                },
                detail: function(e) {
                ...
                error: function(e) {
                    ...
                    a.each(["download", "detail", "open", "batchDownload"], function(t) {
                        var i = s.browserUtil
                                , n = i.isIOS()
                                , o = i.isWechat();
                        e.mm[t] = e.mm[t].before(function() {
                            var e = o && n ? "ios-weixin" : n ? "ios" : "";
                            return "open" == t && void 0 !== arguments[1] && arguments[1] === !1 ? !1 : "" !== e ? (l.show({
                                type: e
                            }),
                                    !1) : !0
                        })
        ...
        Function.prototype.bind || (Function.prototype.bind = function(e) {
                ...
                ,
                c.init(),
                r.on("server.check.success", function(e) {
                    var t = e.args.slice(1)
                            , i = t && t[0] || "";
                    "downloadmm" == i && t.shift(),
                            s.execute.apply(s, t)
                }),
                r.on("server.check.error", function(e) {
                ...
                a.each(document.querySelectorAll("script"), function(e) {
                    var t = e.src;
                    if (t) {
