! function (t, e) {
    ...
    return function (n) {
        ...
        return e(o, n), o.prototype.getCanvasInfo = function () {
            ...
            this.width = t.width, this.height = t.height, this.offsetX = Math.round(t.left + i), this.offsetY = Math.round(t.top + e), this.canvas.width = options.bgImgW, this.canvas.height = options.bgImgH;
